...
export function EditModal({
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col bg-bg-panel sm:max-w-2xl sm:rounded-sm sm:border sm:border-border">
        ...
        <div className="flex-1 space-y-3 overflow-auto p-4">
          ...
          <label className="block">
            ...
            <textarea
              ...
              disabled={saving}
              rows={14}
              className="w-full resize-y rounded-sm border border-border bg-bg-deep p-3 font-serif text-base leading-relaxed focus:border-accent-blue focus:outline-hidden disabled:opacity-50"
            />
          </label>
