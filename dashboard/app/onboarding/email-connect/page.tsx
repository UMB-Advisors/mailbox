  ...
  return (
    <StepShell slug="email-connect">
      ...
      <ul className="list-disc space-y-1 pl-5 text-neutral-400">
        <li>Open a Gmail consent screen so the appliance can read inbox + send replies on your behalf.</li>
        <li>Hand the resulting refresh token to n8n's encrypted credential store.</li>
        <li>Kick off the first 90-day backfill so the persona extractor has a corpus to learn from.</li>
      </ul>
    </StepShell>
  );
}
